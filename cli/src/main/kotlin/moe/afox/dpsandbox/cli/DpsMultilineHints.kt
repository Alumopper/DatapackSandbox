...
object DpsMultilineHints {
    fun describe(
        ...
        profile: VersionProfile = VersionProfiles.default,
    ...
    private val details =
        mapOf(
            ...
            "summon" to "create an entity with validated NBT, including modeled display/armor stand/marker/interaction state",
            ...
            "place" to "place modeled structure, template, jigsaw, and feature resources",
