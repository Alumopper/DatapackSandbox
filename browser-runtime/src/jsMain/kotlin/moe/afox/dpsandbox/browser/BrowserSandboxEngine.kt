...
class BrowserSandboxEngine(
    ...
    biomesCsv: String,
    biomeTagsCsv: String,
    damageTypesCsv: String,
    enchantmentsCsv: String,
    effectsCsv: String,
    ...
    soundsCsv: String,
    gamerulesCsv: String,
    scoreboardCriteriaCsv: String,
    advancementsCsv: String,
    recipesCsv: String,
    pointOfInterestTypesCsv: String,
    pointOfInterestTypeTagsCsv: String,
    structuresCsv: String,
    structureTagsCsv: String,
    configuredFeaturesCsv: String,
    templatePoolsCsv: String,
    testInstancesCsv: String,
    worldClocksCsv: String,
    timelinesCsv: String,
    ...
    private val session =
        EngineSession(version, limits).also { engine ->
            engine.configure(
                roots = rootsCsv.csv(),
                blocks = blocksCsv.csv(),
                items = itemsCsv.csv(),
                entities = entitiesCsv.csv(),
                biomes = biomesCsv.csv(),
                biomeTags = biomeTagsCsv.csv(),
                damageTypes = damageTypesCsv.csv(),
                enchantments = enchantmentsCsv.csv(),
                effects = effectsCsv.csv(),
                dimensions = dimensionsCsv.csv(),
                attributes = attributesCsv.csv(),
                particles = particlesCsv.csv(),
                sounds = soundsCsv.csv(),
                gamerules = gamerulesCsv.csv(),
                scoreboardCriteria = scoreboardCriteriaCsv.csv(),
                advancements = advancementsCsv.csv(),
                recipes = recipesCsv.csv(),
                pointOfInterestTypes = pointOfInterestTypesCsv.csv(),
                pointOfInterestTypeTags = pointOfInterestTypeTagsCsv.csv(),
                structures = structuresCsv.csv(),
                structureTags = structureTagsCsv.csv(),
                configuredFeatures = configuredFeaturesCsv.csv(),
                templatePools = templatePoolsCsv.csv(),
                testInstances = testInstancesCsv.csv(),
                worldClocks = worldClocksCsv.csv(),
                timelines = timelinesCsv.csv(),
            )
        }
