...
| `worldgen/configured_feature` | `modeled` | simple_block, random_patch, and flower feature JSON consumed by place feature |
...
| `worldgen/placed_feature` | `modeled` | placed feature JSON resolving configured simple_block/random_patch/flower resources for place feature |
...
simple_block plus deterministic random_patch/flower feature placement, chat type metadata in modeled chat commands, and
