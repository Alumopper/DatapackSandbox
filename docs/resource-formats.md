...
| `worldgen/configured_feature` | `modeled` | simple_block, block_column, disk, vegetation_patch, tree, basalt_columns, delta_feature, lake, replace_single_block, replace_blob, selector, random_patch, flower, and ore feature JSON consumed by place feature |
...
simple_block, block_column, deterministic disk/vegetation_patch/tree/basalt_columns/delta_feature/lake/replacement/selector/random_patch/flower and sparse-world ore feature placement, chat type metadata in modeled chat commands, and
