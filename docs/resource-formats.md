...
entity dimensions, health, equipment, active effects, and attributes, plus scoreboards, storage,
...
`entity` assertions can check existence/count after type/tag/uuid/position/dimension/health
