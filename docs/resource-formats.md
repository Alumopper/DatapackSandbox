...
| `worldgen/configured_feature` | `modeled` | simple_block, block_column, selector, random_patch, flower, and ore feature JSON consumed by place feature |
...
| `worldgen/placed_feature` | `modeled` | placed feature JSON resolving configured simple_block/block_column/selector/random_patch/flower/ore resources for place feature |
...
simple_block, block_column, deterministic selector/random_patch/flower and sparse-world ore feature placement, chat type metadata in modeled chat commands, and
