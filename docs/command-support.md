...
| CLI `run --fail-on-missing-resources` | Fail a quick run when direct load/tick tag or advancement parent/reward references point at missing resources, useful before creating a full manifest. |
