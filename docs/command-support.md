...
| `teleport`, `tp` | Partial | Coordinate teleport with optional rotation and destination-entity teleport with copied rotation; local-coordinate/facing semantics remain incomplete. |
