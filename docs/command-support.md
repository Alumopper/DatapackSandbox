...
| CLI `run --fail-on-missing-resources` | Fail a quick run when direct load/tick tag, advancement parent/reward, predicate reference, or nested loot table references point at missing resources, useful before creating a full manifest. |
