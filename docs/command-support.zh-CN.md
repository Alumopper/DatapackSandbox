...
| `inspect <...>` | `modeled` | 查看 score、storage、random sequence、entities、blocks、player、loot、predicate、advancement、recipe、item_modifier、raw JSON resource、tags、resource index、registry group、outputs 和玩家事件 trace。 |
