...
| `execute` | 部分支持 | 支持 `as`、`at`、`positioned`、`align`、`anchored`、`facing`、`in`、`rotated`、`store`、`if`、`unless`、`run` 的核心路径；条件覆盖 `entity`、`score`、`data`、`block`。 |
...
| `inspect <...>` | 查看 score、storage、entities、blocks、player、loot、predicate、advancement、registry、outputs。 |
