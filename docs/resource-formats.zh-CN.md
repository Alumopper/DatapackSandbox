...
| `worldgen/configured_feature` | `modeled` | simple_block 和确定性 random_patch/flower feature JSON 可被 place feature 消费。 |
...
| `worldgen/placed_feature` | `modeled` | placed feature 会解析 configured simple_block/random_patch/flower 资源，供 place feature 使用。 |
