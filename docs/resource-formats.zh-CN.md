...
| `worldgen/configured_feature` | `modeled` | simple_block、selector、random_patch、flower 和 ore feature JSON 可被 place feature 消费。 |
...
| `worldgen/placed_feature` | `modeled` | placed feature 会解析 configured simple_block/selector/random_patch/flower/ore 资源，供 place feature 使用。 |
