...
fun unsupportedFeature(message: String, version: String? = null, location: SourceLocation? = null, command: String? = null): Nothing {
...
fun commandError(message: String, location: SourceLocation? = null, command: String? = null): Nothing {
    throw SandboxException(
