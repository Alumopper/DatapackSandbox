...
object ResourceCatalog {
    ...
    private val modeledRawJsonSummaries = mapOf(
        ...
        "worldgen/configured_feature" to "simple_block, block_column, disk, vegetation_patch, replace_single_block, replace_blob, selector, random_patch, flower, and ore feature JSON consumed by place feature",
        "worldgen/placed_feature" to "placed feature JSON resolving configured simple_block/block_column/disk/vegetation_patch/replace_single_block/replace_blob/selector/random_patch/flower/ore resources for place feature",
