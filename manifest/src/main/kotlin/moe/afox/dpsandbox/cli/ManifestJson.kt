...
internal fun JsonObject.manifestArray(
    name: String,
...
internal fun JsonObject.manifestStringArray(
    name: String,
    label: String = "Manifest '$name'",
): List<String> =
...
internal fun JsonObject.manifestString(name: String): String? = get(name)?.takeIf { it.isJsonPrimitive }?.asString
...
internal fun parseManifestBlockPos(
    array: JsonArray?,
    label: String = "Block position",
): BlockPos {
...
internal fun parseManifestPosition(
    array: JsonArray?,
...
internal fun parseManifestChunk(
    array: JsonArray?,
    label: String = "Chunk position",
): ChunkPos {
...
internal fun parseManifestChunks(
    array: JsonArray?,
    label: String = "chunks",
): List<ChunkPos> {
...
internal fun parseManifestNbtObject(
    value: JsonElement?,
    label: String = "NBT value",
): JsonObject? =
    when {
        value == null -> null
...
internal fun manifestPrimitiveString(value: JsonElement): String = if (value.isJsonPrimitive) value.asString else JsonValues.render(value)
